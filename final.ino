...
const char* ssid = "Antonon 5GHz";             //SSID da rede WIFI
const char* password =  "38321012";    //senha da rede wifi
//Informações da Instância do broker MQTT
const char* mqttServer = "broker.mqtt-dashboard.com";   //server
const char* mqttUser = "artur";              //user
const char* mqttPassword = "210388";      //password
const int mqttPort = 1880;                     //port
const char* mqttTopicSub = "pump";      //tópico que será assinado no Broker
